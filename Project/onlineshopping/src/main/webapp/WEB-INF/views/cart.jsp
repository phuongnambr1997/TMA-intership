			...
			<table id="cart" class="table table-hover table-condensed">
				...
				<tbody>
					...
					<tr>
						...
						<td data-th="Price"> <fmt:formatNumber value = " ${cartLine.buyingPrice}"/> VND</td>
						<td data-th="Quantity">
							<input type="number" id="count_${cartLine.id}" class="form-control text-center" value="${cartLine.productCount}" min="1" max="3">
						</td>
						<td data-th="Subtotal" class="text-center"> <fmt:formatNumber value = " ${cartLine.total}"/> VND </td>
				...
				<tfoot>
					<tr class="visible-xs">
						<td class="text-center"><strong>Total  <fmt:formatNumber value = "${userModel.cart.grandTotal}"/> VND</strong></td>
					</tr>
					<tr>
						...
						<td class="hidden-xs text-center"><strong>Total <fmt:formatNumber value = "${userModel.cart.grandTotal}"/> VND</strong></td>
