...
<title>Mobile Shop - Membership</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
           ...
           <div class="navbar-header">
               <a class="navbar-brand" href="${contextRoot}/home">Mobile Shop</a>
           </div>
		</div>
	</nav>
		    						...
		    						<tbody>
		    							...
		    							<c:forEach items="${orderDetail.orderItems}" var="orderItem">
			    							<tr>
			    								...
			    								<td class="text-center"> <fmt:formatNumber value = "${orderItem.buyingPrice}"/> VND</td>
			    								<td class="text-center">${orderItem.productCount}</td>
			    								<td class="text-right"> <fmt:formatNumber value = "${orderItem.total}"/>VND</td>
			    							</tr>
		    							</c:forEach>
		    						</tbody>
		    					</table>
